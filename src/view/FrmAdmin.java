...
public class FrmAdmin extends javax.swing.JFrame {
    ...
    String admin;
    AcessoController acessoControllerAdmin;
    
    public FrmAdmin(String nome, String email, AcessoController acessoControllerLogin) {
        admin = nome;
        acessoControllerAdmin = acessoControllerLogin;
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        setVisible(false);
        new BemVindo(admin, acessoControllerAdmin).setVisible(true);

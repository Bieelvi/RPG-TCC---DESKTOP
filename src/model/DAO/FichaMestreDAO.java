...
public class FichaMestreDAO {
    ...
    public ArrayList<FichaMestre> puxaFichas(int codMestre) throws SQLException{
        jogadorDAO = new JogadorDAO();
        ArrayList<FichaMestre> banco = null;
        ResultSet rs;
        
        try{
            con = new Conexao().getConnection();
            String sql = "Select * from ficha_mestre where codigo_mestre = ?";
            PreparedStatement stmt = con.prepareStatement(sql);
